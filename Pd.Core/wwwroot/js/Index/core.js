    ...
    [{
        ...
        data: [[{
            ...
            func: function () {
                ...
                $("#lxcn").attr("style", 'background:url(images/background.jpg) repeat right bottom transparent;background-size:100%;');
               
            }
        }, {
            text: "背景2",
            func: function() {
                $("#lxcn").attr("style",'background:url(images/background2.jpg) repeat right bottom transparent;background-size:100%;');
            }       
        }]]
    }]
    ],
